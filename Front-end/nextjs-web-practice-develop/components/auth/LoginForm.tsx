 ...
 * LoginForm.tsx, 4/13/2026 NguyenHuyHoang
 */
'use client';
...
/**
 * Component Biểu mẫu đăng nhập.
 * Chứa logic kết nối `react-hook-form` với Zod Parser để Validate độ dài chuỗi ký tự nhập vào.
 * Khi nhận Response 200, kích hoạt hàm ghi Cookie/Storage và điều hướng vào trang trong.
 */
