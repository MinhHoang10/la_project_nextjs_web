 ...
 * Cung cấp các phương thức truy vấn tùy chỉnh để hỗ trợ màn hình danh sách (ADM002).
 * 
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    /**
     * Đếm tổng số lượng nhân viên thỏa mãn điều kiện tìm kiếm.
     ...
     * Sử dụng kỹ thuật "Constructor Projection" để ánh xạ trực tiếp kết quả vào EmployeeDTO,
